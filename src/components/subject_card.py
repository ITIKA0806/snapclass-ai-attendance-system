...
<p style="color:#64748b; margin:10px 0;">Code : <span style="background:#E0E3FF; color:#5865F2; padding:2px 8px; border-radius:5px;">{code}</span> &nbsp; | &nbsp; Section : <span style="background:#E0E3FF; color:#5865F2; padding:2px 8px; border-radius:5px;">{section}</span></p>
"""
