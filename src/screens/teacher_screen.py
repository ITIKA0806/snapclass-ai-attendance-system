        ...
        if st.button(
            ...
            with st.spinner('Deep scanning classroom photos...'):
                ...
                for idx, img in enumerate(st.session_state.attendance_images):
                    ...
                    result = predict_attendance(img_np)
...
def teacher_screen_login():
    ...
    st.header('Welcome back', text_alignment='center')
    st.space()


    teacher_username = st.text_input("Enter username", placeholder="maya_smith")
    ...
    with btnc1:
         if st.button('Log in',icon=':material/passkey:', shortcut='control+enter', width='stretch'):
